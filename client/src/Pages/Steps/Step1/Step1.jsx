          ...
          <div className="features">
            ...
            <div className="one">
              ...
              <div className="pass-btns">
                 ...
                 <Link to='/step2'><Button title='Continuar'/></Link>
              </div>
              <div className="items">
            ...
            <div className="one">
              <div className="text">
                ...
                <p>
                Veja todos os itens que correspondem a pagamentos ou impostos que você pagou em 2021.
                </p>
              </div>
              <div className="items">
            ...
            <div className="one">
              <div className="text">
                ...
                <p>
                Veja todos os itens que correspondem a qualquer tipo de dívida ou pendências com a Receita Federal ou outros órgãos que você possuía em 2021.
                </p>
              </div>
              <div className="items">
