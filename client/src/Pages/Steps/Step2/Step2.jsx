              ...
              <div className='step-features'>
                  <div className='one'>
                      <div className='text'>
                        ...
                        <p>De acordo com as informações apresentadas, precisaremos dos documentos a seguir para comprovar seus bens e movimentações.</p>
                      </div>
                      <div className="pass-btns">
                          <Link to='/step1'>Retornar etapa anterior</Link>
                          <Link to='/step3'><Button title='Continuar'/></Link>
                      </div>
                      <div className='box'>
                        <ul>
                          ...
                          <li>Comprovante de rendimentos da empresa que você trabalhou</li>
